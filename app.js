...
// // Q3
// var signal01 = prompt("Enter first Signal color to know its Message.").toLowerCase();
// var signal02 = prompt("Enter second Signal color to know its Message.").toLowerCase();
// var signal03 = prompt("Enter Third Signal color to know its Message.").toLowerCase();
...
//     "</tr>" +
//     "<tr>" +
//     "<td>" + signal01.toUpperCase() + "</td>")

// if (signal01 === "red") {
//     document.write("<td>Must stop </td>")
// } else if (signal01 === "yellow") {
//     document.write("<td>Ready to move</td>")
// } else if (signal01 === "green") {
...
// document.write("</tr>" +
//     "<tr>" +
//     "<td>" + signal02.toUpperCase() + "</td>");
// if (signal02 === "red") {
//     document.write("<td>Must stop </td>")
// } else if (signal02 === "yellow") {
//     document.write("<td>Ready to move</td>")
// } else if (signal02 === "green") {
//     document.write("<td>Move Now</td>")
// } else {
//     document.write("<td>Invalid color</td>")
// }
...
//     "</tr>" +
//     "<tr>" +
//     "<td>" + signal03.toUpperCase() + "</td>");
// if (signal03 === "red") {
//     document.write("<td>Must stop </td>")
// } else if (signal03 === "yellow") {
//     document.write("<td>Ready to move</td>")
// } else if (signal03 === "green") {
//     document.write("<td>Move Now</td>")
// } else {
//     document.write("<td>Invalid color</td>")
// }
